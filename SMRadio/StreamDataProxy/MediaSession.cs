...
namespace StreamData.Core
{
    public class MediaSession
    {
            ...
            int clientRtpPort, int clientRtcpPort)
        {
            ...
            Socket socket = null;
            socket = Utility.CreateUdpSocket(clientRtpPort);
            if (socket == null)
            {
                return false;
            }
            ...
            socket = Utility.CreateUdpSocket(clientRtcpPort);
            if (socket != null)
            {
        ...
        private bool ParseSdpRangeAttribute(string[] sdpArray)
        {
            ...
            PlayStartTime = Utility.StringToDouble(rangeStartStr);
            PlayEndTime = Utility.StringToDouble(rangeEndStr);
        ...
        private bool ParseSdpSizeAttribute(string[] sdpArray)
        {
            ...
            FileSize = Utility.StringToLong(fileSize);
