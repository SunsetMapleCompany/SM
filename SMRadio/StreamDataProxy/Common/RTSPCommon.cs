...
namespace StreamData.Core.Common
{
    public static class RTSPCommon
    {
        ...
        public static bool ParsePortNumber(string[] srcArray, string subString, out int rtpPort, out int rtcpPort)
        {
            ...
            rtpPort = Utility.StringToInteger(rtpPortStr);
            rtcpPort = Utility.StringToInteger(rtcpPortStr);
        ...
        public static bool ParseScaleHeader(string srcString, out float scale)
        {
            ...
            scale = Utility.StringToFloat(temp);
            ...
            out double rangeStart, out double rangeEnd)
        {
            ...
            rangeStart = Utility.StringToDouble(rangeStartStr);
            rangeEnd = Utility.StringToDouble(rangeEndStr);
