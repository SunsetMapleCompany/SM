   ...
   public static class Utility
    {
        ...
        public static Socket CreateUdpSocket(int port)
        {
            ...
            {
                Utility.OutputMessage(false, MsgLevel.Error, "Utility -- CreateUdpSocket", e.Message);
            }
        ...
        public static string CreateDirectory(string dir)
        {
            ...
            if (Directory.Exists(dir))
            {
                ...
                newDir = Utility.AddBackSlash(currentDir) + dir;
            }
            else
            {
                try
                ...
                {
                    Utility.OutputMessage(false, MsgLevel.Error, "Utility -- CreateDirectory", e.Message);
                }
            }
        ...
        public static byte[] StringToBytes(string s)
        {
            ...
            {
                Utility.OutputMessage(false, MsgLevel.Error, "Utility -- StringToBytes", e.Message);
            }
        ...
        public static string BytesToString(byte[] b, int length)
        {
            ...
            {
                Utility.OutputMessage(false, MsgLevel.Error, "Utility -- BytesToString", e.Message);
            }
        ...
        public static byte[] LongToBytes(long number)
        {
            ...
            {
                Utility.OutputMessage(false, MsgLevel.Error, "Utility -- LongToBytes", e.Message);
            }
        ...
        public static long BytesToLong(byte[] b)
        {
            ...
            {
                Utility.OutputMessage(false, MsgLevel.Error, "Utility -- BytesToLong", e.Message);
            }
        ...
        public static int BytesToInteger(byte[] b)
        {
            ...
            {
                Utility.OutputMessage(false, MsgLevel.Error, "Utility -- BytesToInteger", e.Message);
            }
        ...
        public static int StringToInteger(string s)
        {
            ...
            if (!string.IsNullOrEmpty(s))
            {
                ...
                {
                    Utility.OutputMessage(false, MsgLevel.Error, "Utility -- StringToInteger", e.Message);
                }
            }
        ...
        public static long StringToLong(string s)
        {
            ...
            if (!string.IsNullOrEmpty(s))
            {
                ...
                {
                    Utility.OutputMessage(false, MsgLevel.Error, "Utility -- StringToLong", e.Message);
                }
            }
        ...
        public static float StringToFloat(string s)
        {
            ...
            if (!string.IsNullOrEmpty(s))
            {
                ...
                {
                    Utility.OutputMessage(false, MsgLevel.Error, "Utility -- StringToFloat", e.Message);
                }
            }
        ...
        public static double StringToDouble(string s)
        {
            ...
            if (!string.IsNullOrEmpty(s))
            {
                ...
                {
                    Utility.OutputMessage(false, MsgLevel.Error, "Utility -- StringToDouble", e.Message);
                }
            }
        ...
        public static int GenerateRandomNumber(int minValue, int maxValue)
        {
            ...
            {
                Utility.OutputMessage(false, MsgLevel.Error, "Utility -- GenerateRandomNumber", e.Message);
            }
