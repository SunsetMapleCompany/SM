    ...
    public class FileSink
    {
        ...
        public void WriteDataToFile(byte[] frameBuffer, int frameSize, long position)
        {
            lock (mutex)
            {
                ...
                {
                    Utility.OutputMessage(false, MsgLevel.Error, "FileSink -- WriteDataToFile", e.Message);
                }
            }
        }
        ...
        private void InitFileStream()
        {
            lock (mutex)
            {
                ...
                {
                    Utility.OutputMessage(false, MsgLevel.Error, "FileSink -- InitFileStream", e.Message);
                }
            }
        }
        #endregion
