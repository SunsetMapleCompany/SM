        ...
        public override void SendDatagram(byte[] sendBuffer, int sendBufferSize)
        {
            lock (mutex)
            {
                ...
                catch (System.Exception e)
                {
                    ...
                    Utility.OutputMessage(false, MsgLevel.Error, "ClientSocketUdp -- SendDatagram", e.Message);
                }
            }
        }
        ...
        public override void ReceiveDatagram()
        {
            lock (mutex)
            {
                ...
                catch (System.Exception e)
                {
                    this.OnClientTeardown();
                    this.OnExceptionOccurred(e);
                    Utility.OutputMessage(false, MsgLevel.Error, "ClientSocketUdp -- ReceiveDatagram", e.Message);
                }
            }
        }
        ...
        protected override void EndSendDatagram(IAsyncResult iar) 
        {
            lock (mutex)
            {
                ...
                catch (System.Exception e)
                {
                    this.OnClientTeardown();
                    this.OnExceptionOccurred(e);
                    Utility.OutputMessage(false, MsgLevel.Error, "ClientSocketUdp -- EndSendDatagram", e.Message);
                }
            }
        }
        ...
        protected override void EndReceiveDatagram(IAsyncResult iar)
        {
            lock (mutex)
            {
                ...
                catch (System.Exception e)
                {
                    this.OnClientTeardown();
                    this.OnExceptionOccurred(e);
                    Utility.OutputMessage(false, MsgLevel.Error, "ClientSocketUdp -- EndReceiveDatagram", e.Message);
                }
            }
        }
